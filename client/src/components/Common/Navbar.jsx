...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation */}
      <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-[#ffffff] shadow-lg transform transition-transform duration-300 z-50 ${
        ...
        <div className="p-4">
          ...
          <nav className="space-y-4">
            <Link to="#" onClick={toggleNavDraw} className="block text-gray-600 hover:text-black">
              Men
            </Link>
            <Link to="#" onClick={toggleNavDraw} className="block text-gray-600 hover:text-black">
              Women
